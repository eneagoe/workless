  ...
  context 'with jobs' do
    ...
    context 'without workers' do
      ...
      it 'should set the workers to 1' do
        Delayed::Workless::Scaler::HerokuCedar.client.formation.should_receive(:update).once.with(ENV['APP_NAME'], 'worker', {"quantity" => "1"})
  ...
  context 'with no jobs' do
    ...
    context 'with workers' do
      ...
      it 'should set the workers to 0' do
        Delayed::Workless::Scaler::HerokuCedar.client.formation.should_receive(:update).once.with(ENV['APP_NAME'], 'worker', {"quantity" => "0"})
        Delayed::Workless::Scaler::HerokuCedar.down
      end
